...
def viz_temporal_clusterings(temporal_clusterings, store_path=None, labels=None):
    ...
    for i, tc in enumerate(temporal_clusterings):
        _add_subplot(fig, gs, i, colorings[tc][None, :, :], labels[i] if labels is not None else "")
...
# of ground-truth.
def viz_temporal_clusterings_with_segment_spacing(primary_temporal_clustering, temporal_clusterings,
                                                  store_path=None, labels=None):
...
def viz_temporal_clusterings_by_segments(primary_temporal_clustering, temporal_clusterings, store_path=None, labels=None):
    # Get the number of temporal clusterings
    num_seqs = len(temporal_clusterings)
    ...
    for i, tc in enumerate(temporal_clusterings):
        ...
        # Create lists that will correctly format segments by grouping labels from the primary temporal clustering
